...
import { Link2, Files, Terminal, LogOut, Trash2, Calendar, FileText, ChevronDown, ChevronRight, Copy, Check, Plus } from 'lucide-react';
            ...
            <div className="max-w-7xl mx-auto px-6 mt-8">
                <div className="flex gap-2 border-b border-slate-200 dark:border-slate-800">
                    <button
                        ...
                        className={`flex items-center gap-2 px-4 py-2.5 text-sm font-semibold border-b-2 transition ${activeTab === 'links'
                    ...
                    <button
                        ...
                        className={`flex items-center gap-2 px-4 py-2.5 text-sm font-semibold border-b-2 transition ${activeTab === 'collections'
                                ? 'border-blue-600 text-blue-600'
                                : 'border-transparent text-slate-500 hover:text-slate-900 dark:hover:text-slate-100'
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`flex items-center gap-2 px-4 py-2.5 text-sm font-semibold border-b-2 transition ${activeTab === 'logs'
                                ? 'border-blue-600 text-blue-600'
                                : 'border-transparent text-slate-500 hover:text-slate-900 dark:hover:text-slate-100'
                            }`}
                    >
                                                    ...
                                                    links.map((link) => (
                                                        <tr key={link._id}>
                                                            ...
                                                            <td className="px-6 py-4 capitalize">
                                                                <span className={`px-2 py-0.5 rounded-full text-[10px] font-bold ${link.type === 'send' ? 'bg-indigo-50 text-indigo-700 dark:bg-indigo-950/20' :
                                                    ...
                                                    logs.map((log) => (
                                                        <tr key={log._id}>
                                                            ...
                                                            <td className="px-6 py-4 font-bold">
                                                                <span className={`px-2 py-0.5 rounded-full text-[10px] uppercase font-bold ${log.level === 'error' ? 'bg-red-50 text-red-700 dark:bg-red-950/20' :
